      ...
      async models(provider, ctx) {
        ...
        if (ctx.auth?.type !== "oauth") {
          ...
          return Object.fromEntries(
            Object.entries(internal.models ?? {}).map(([id, model]) => [id, fix(model as unknown as Model, base())]),
          )
        }
        ...
        return CopilotModels.get(
          ...
          {
            ...(internal.options?.headers as Record<string, string> | undefined),
          ...
          .catch((error) => {
            models = {}
            return Object.fromEntries(
              Object.entries(internal.models ?? {}).map(([id, model]) => [
                id,
                fix(model as unknown as Model, base(auth.enterpriseUrl)),
              ]),
            )
          })
      },
