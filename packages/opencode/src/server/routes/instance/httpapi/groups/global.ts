...
import { PublicConfigSchema } from "@opencode-ai/core/v1/config/public"
  ...
  HttpApiGroup.make("global")
    .add(
      ...
      HttpApiEndpoint.get("configGet", GlobalPaths.config, {
        success: described(PublicConfigSchema, "Get global config info"),
      }).annotateMerge(
        OpenApi.annotations({
      ...
      HttpApiEndpoint.patch("configUpdate", GlobalPaths.config, {
        ...
        success: described(PublicConfigSchema, "Successfully updated global config"),
