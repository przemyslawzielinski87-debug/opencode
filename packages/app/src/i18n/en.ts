export const dict = {
  ...
  "dialog.project.edit.icon.error.empty": "Selected file is empty.",
  "dialog.project.edit.icon.error.size": "File is too large. Maximum size is 1 MiB.",
  "dialog.project.edit.icon.error.type": "Only PNG, JPEG, and WebP images are supported.",
  "dialog.project.edit.icon.error.mismatch": "File extension does not match the image type.",
  ...
  "status.popover.tab.overview": "Overview",
  "status.popover.overview.mcp": "MCP servers",
  "status.popover.overview.lsp": "LSP servers",
  "status.popover.overview.plugins": "Plugins",
  "status.popover.overview.status.healthy": "Healthy",
  "status.popover.overview.status.degraded": "Degraded",
  "status.popover.overview.status.failed": "Server offline",
  "status.popover.overview.status.connecting": "Connecting...",
  "status.popover.status.connected": "Connected",
  "status.popover.status.disabled": "Disabled",
  "status.popover.status.failed": "Failed",
  "status.popover.status.needsAuth": "Needs authentication",
  "status.popover.status.needsRegistration": "Needs registration",
  "status.popover.retry": "Retry",
  "status.popover.error.title": "Could not load status",
  "status.popover.error.description": "Check your connection and try again.",
