export const dict = {
  ...
  "status.popover.tab.overview": "Przegląd",
  "status.popover.overview.mcp": "Serwery MCP",
  "status.popover.overview.lsp": "Serwery LSP",
  "status.popover.overview.plugins": "Wtyczki",
  "status.popover.overview.status.healthy": "Zdrowy",
  "status.popover.overview.status.degraded": "Obniżony",
  "status.popover.overview.status.failed": "Serwer offline",
  "status.popover.overview.status.connecting": "Łączenie...",
  "status.popover.status.connected": "Połączony",
  "status.popover.status.disabled": "Wyłączony",
  "status.popover.status.failed": "Niepowodzenie",
  "status.popover.status.needsAuth": "Wymaga uwierzytelnienia",
  "status.popover.status.needsRegistration": "Wymaga rejestracji",
  "status.popover.retry": "Spróbuj ponownie",
  "status.popover.error.title": "Nie udało się załadować statusu",
  "status.popover.error.description": "Sprawdź połączenie i spróbuj ponownie.",
